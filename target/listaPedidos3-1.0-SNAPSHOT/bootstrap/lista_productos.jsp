...
<%
    ArrayList<Bproductos> lista_productos = (ArrayList<Bproductos>) request.getAttribute("lista");
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class='container-fluid'>
                <h1 class='mb-3'>Lista de productos disponibles</h1>
                <table class="table table-bordered" width="100%" cellspacing="0">
                    <tr>
                        ...
                        <th>
                            <div style=text-align:center>Editar/Eliminar</div>
                        </th>
                    </tr>
                    <%
                        for (Bproductos productos : lista_productos) {
                    %>
                    <tr>
                        <td><%=productos.getNombre()%>
                        </td>
                        <td>
                            <div><%=productos.getDescripcion()%>
                            </div>
                        </td>
                        <td>
                            <div style=text-align:center><%=productos.getCantidad()%>
                            </div>
                        </td>
                        <td>
                            <div style=text-align:center><%="S/" + productos.getPrecioUnitario()%>
                            </div>
                        </td>
                        <td>
